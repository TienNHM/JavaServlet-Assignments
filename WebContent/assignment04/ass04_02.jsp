...
<head>
	...
	<link href="${pageContext.request.contextPath}/assignment04/css/ass04_02.css" rel="Stylesheet" type="text/css">
  ...
  <a class="navbar-brand" href="${pageContext.request.contextPath}/about.jsp">ABOUT</a>
	...
	<div class="bg">
		<form class="formSubmit"
			...
			<input type="hidden" name="action" value="formSubmit_ass04_02">
